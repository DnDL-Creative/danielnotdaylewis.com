  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="w-full overflow-x-auto pb-2">
        <div className="flex items-center justify-between bg-white p-1.5 rounded-full border border-slate-200 shadow-sm min-w-max mx-auto md:mx-0 w-fit">
        ...
        <div className="grid grid-cols-1 gap-6">
          {items.map((r) => {
            ...
            return (
              ...
              >
                {/* 🚨 MOBILE OPTIMIZED LAYOUT: STACKED COL ON MOBILE, ROW ON DESKTOP */}
                <div className="flex flex-col lg:flex-row min-h-[160px]">
                  ...
                  <div className="w-full lg:w-48 p-4 bg-white/50 border-t lg:border-t-0 lg:border-l border-slate-100 flex flex-row lg:flex-col gap-2 justify-center">
                    ...
                    <button
                      ...
                      className="flex-1 lg:flex-none w-full py-3 bg-white border border-slate-200 text-slate-500 rounded-xl text-[10px] font-black uppercase tracking-widest hover:border-emerald-300 hover:text-emerald-600 hover:bg-emerald-50 transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    {isBooted && (
                      <button
                        ...
                        className={`flex-1 lg:flex-none w-full py-3 border rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                          r.is_blacklisted
                    ...
                    <button
                      ...
                      className="flex-1 lg:flex-none w-full py-3 bg-white border border-slate-200 text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:border-red-200 hover:text-red-500 hover:bg-red-50 transition-all flex items-center justify-center gap-2"
                    >
                      <Trash2 size={14} /> Wipe
                    </button>
                  </div>
