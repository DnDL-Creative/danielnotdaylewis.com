...
export default function HomeUI({ initialPosts }) {
          ...
          <section className="space-y-12 w-full pt-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 border-b border-slate-200/60 pb-6">
              ...
              <div className="space-y-4 text-center md:text-left max-w-2xl">
                <h2 className="font-bold text-3xl md:text-5xl uppercase tracking-tight text-slate-900">
                  Insights
                </h2>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${sortOption === opt.value ? "bg-slate-900 text-white shadow-md scale-105" : "bg-white border border-slate-200 text-slate-600 hover:border-slate-300 hover:text-slate-900"}
                      `}
                    >
