...
import {
  PenTool,
  Book, // Updated Icon for Audiobook Production
  LogOut,
  Sparkles,
  Activity,
  Mic, // Icon for Voiceover
} from "lucide-react";
      ...
      <div className="max-w-7xl w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <Link
            ...
            className="group relative p-8 md:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-purple-900/20 hover:border-purple-500/50 transition-all duration-500 overflow-hidden flex flex-col items-center text-center"
          >
            ...
            <h2 className="relative z-10 text-xl md:text-2xl font-black uppercase text-white mb-2 tracking-wide group-hover:text-purple-300 transition-colors">
              Vibe Writer
            </h2>
          ...
          {/* CARD 2: AUDIOBOOK PRODUCTION MANAGER */}
          <Link
            href="/admin/audiobook-production-manager"
            className="group relative p-8 md:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-teal-900/20 hover:border-teal-500/50 transition-all duration-500 overflow-hidden flex flex-col items-center text-center"
          >
            ...
            <h2 className="relative z-10 text-xl md:text-2xl font-black uppercase text-white mb-2 tracking-wide group-hover:text-teal-300 transition-colors">
          ...
          {/* CARD 3: VOICEOVER TRACKER */}
          <Link
            href="/admin/voiceover-tracker"
            className="group relative p-8 md:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-blue-900/20 hover:border-blue-500/50 transition-all duration-500 overflow-hidden flex flex-col items-center text-center md:col-span-2 lg:col-span-1"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            <div className="relative z-10 w-20 h-20 rounded-2xl bg-blue-500/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-blue-500/30 text-blue-400">
              <Mic size={36} />
            </div>

            <h2 className="relative z-10 text-xl md:text-2xl font-black uppercase text-white mb-2 tracking-wide group-hover:text-blue-300 transition-colors">
              Voiceover Tracker
            </h2>
            <p className="relative z-10 text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-blue-400/80 transition-colors">
              Auditions & Bookings
            </p>
